...
class Admin extends CI_Controller
{
    ...
    public function add_guru()
    {
        ...
        $this->form_validation->set_rules('nama', 'Nama', 'required|trim|min_length[4]', [
            'required' => 'Harap isi kolom Nama Pelajaran.',
            'min_length' => 'Nama  terlalu pendek.',
        ]);
    ...
    public function data_materi()
    {
        ...
        $data['user'] = $this->m_materi->get_materimapel()->result();
        $this->load->view('template_admin/nav');
    ...
    public function tambah_materi()
    {
        ...
        $data['nama_guru'] = $this->mguru->tampil_data()->result_array();

        $data['t_guru'] = $this->db->get('guru')->result_array();
        $data['nama_mapel'] = $this->db->get('mapel')->result_array();
        $data['t_mapel'] = $this->M_mapel->get_mapelguru()->result_array();
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($upload_video) {
                $config['allowed_types'] = 'mp4|mkv|mov|pdf';
                $config['max_size'] = '0';
    ...
    public function data_mapel()
    {
        ...
        $data['mapelguru'] = $this->M_mapel->get_mapelguru()->result();
        $this->load->view('template_admin/nav');
    ...
    public function add_mapel()
    {
        ...
        $this->form_validation->set_rules('n_mapel', 'n_mapel', 'required|trim|min_length[4]', [
            'required' => 'Harap isi kolom Nama Pelajaran.',
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($upload_cover) {
                ...
                $config['max_size'] = '0';
                $config['upload_path'] = './assets/img/modul_cover/';
            ...
            $data = [
                'n_mapel' => htmlspecialchars($this->input->post('n_mapel', true)),
            ...
            // $r_data = [
            //     'id_mapel' => htmlspecialchars($this->input->post('n_mapel', true)),
            // ];
