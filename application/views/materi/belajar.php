        ...
        <div class="row">
            <div class="col-md-12 mx-auto mt-4">
                <!-- <video class="afterglow" autoplay id="myvideo" width="1280" height="720">
                    <source type="video/mp4" autoplay src="<?= base_url() . 'assets/upload/' . $detail->video; ?>" />
                </video> -->

                <embed type="application/pdf" src="<?= base_url() . 'assets/upload/' . $detail->video; ?>" width="1280" height="720"></embed>
            </div>
        </div>
    </div>
    <!-- End Video Player -->
