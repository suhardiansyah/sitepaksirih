...
<div class="main-content">
    <section class="section">
        <div class="card" style="width:100%;">
            <div class="card-body">
                <h2 class="card-title" style="color: black;">Management Data Guru Si Tepak Sirih</h2>
                <hr>
                <p class="card-text">Jumlah Guru yang terdaftar di Si Tepak Sirih sekarang adalah
                    <span class="font-weight-bold" style="color:black;">
                        <?php echo $this->db->count_all('guru'); ?> Guru.
                    </span>Guru tidak dapat melakukan pendaftaran online sendiri. Hanya admin yang diperkenankan untuk mendaftarkan guru.
                </p>
