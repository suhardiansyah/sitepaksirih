                ...
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            ...
                            <hr>
                            <p class="card-text">Jumlah Materi yang terdata di Si Tepak Sirih sekarang adalah
                                <span class="font-weight-bold" style="color:black;">
                                    <?php echo $this->db->count_all('materi'); ?> Materi.
                                </span>Materi dapat ditambah oleh guru maupun admin, materi meliputi video, deskripsi dan modul - modul Pembelajaran
                            </p>
