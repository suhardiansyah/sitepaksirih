            ...
            <div class="main-content">
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Materi Si Tepak Sirih</h2>
                            <hr>
                            <p class="card-text">Jumlah Materi yang terdaftar di Si Tepak Sirih sekarang adalah
                                <span class="font-weight-bold" style="color:black;">
                                    <?php echo $this->db->count_all('materi'); ?> Materi.
                                </span>
                            </p>
                            <a href="<?= base_url('guru/add_materi') ?>" class="btn btn-success"><i class="fa fa-plus-square"></i> Tambah Materi</a><br><br>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="bg-white p-4" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                                ...
                                <div class="col-md- col-sm-2 col-xs-2" align="center">Nama Materi <br>
                                            ...
                                            ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?php echo site_url('admin/update_Materi/' . $u->id_Materi); ?>" class="btn btn-success"><i class="fa fa-edit"></i> Edit</a>
                                                        <a href="<?php echo site_url('guru/delete_Materi/' . $u->id_Materi); ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Delete</a>
                                                    </td> -->
                                                </tr>
                                            <?php
                                            }
