...
<head>
    ...
    <title>Si Tepak Sirih - Instruktur Login</title>
            ...
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <h4 class="text-dark font-weight-normal">Selamat datang di <span class="font-weight-bold">Si Tepak Sirih</span>
                        </h4>
                        <p class="text-muted">Sebelum masuk ke halaman Instruktur, anda harus login terlebih dahulu sebagai
                            Instruktur. silahkan isi data dibawah untuk melanjutkan.</p>
                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="<?= base_url('assets/') ?>stisla-assets/img/unsplash/ss.jpg">
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="mb-5 pb-3">
                                <h1 class="mb-2 display-4 font-weight-bold text-white">Selamat datang, Instruktur!</h1>
                                <h5 class="font-weight-normal text-muted-transparent text-white">Silahkan login untuk
                                    masuk ke
                                    halaman instruktur.</h5>
                            </div>

                            <!-- Powered by <a class="text-light bb" target="_blank" href="https://suhardiansyah.com/">Suhardiansyah.com</a> - Image by <a class="text-light bb" target="_blank" href="https://unsplash.com">Unsplash</a> -->
                        </div>
                    </div>
                </div>
            </div>
