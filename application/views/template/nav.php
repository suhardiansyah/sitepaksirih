...
<head>
    ...
    <meta content="E-Modul dibuat ditujukan agar para siswa dan instruktur dapat terus belajar dan mengajar dimana saja dan kapan saja." name="Description" />
    <meta content="E-Modul, E-learning, " name="keywords" />
    <link rel="icon" href="<?= base_url('assets/') ?>img/favicon.png" type="image/png">
    <title>Si Tepak Sirih - Sistem Informasi Tempat Bagi Ilmu dan Informasi Kesehatan!</title>
    <!-- Bootstrap CSS -->
