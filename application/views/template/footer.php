    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="<?= base_url('welcome/tentang') ?>">Tentang Si Tepak Sirih</a></li>
                        <li><a href="<?= base_url('welcome/Berita') ?>">Pengumuman Si Tepak Sirih</a></li>
                        <li><a href="<?= base_url('welcome/kontak') ?>">Kontak Si Tepak Sirih</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        ...
                        <li><a href="<?= base_url('welcome/guru') ?>">Untuk Instruktur</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="javaScript:void(0);">Modul1</a></li>
                        <li><a href="javaScript:void(0);">Modul2</a></li>
                        <li><a href="javaScript:void(0);">Modul3</a></li>

                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <h4 class="footer_title">Tentang Si Tepak Sirih</h4>
                <p>
                    Si Tepak Sirih adalah Web edukasi yang dilengkapi video, materi yang tersedia secara gratis. Si Tepak Sirih dibuat ditujukan agar para siswa dan instruktur dapat terus belajar dan mengajar dimana saja dan kapan saja.
                </p>
            </div>
        </div>
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                </script> All rights reserved | Si Tepak Sirih is powered by <a href="https://suhardiansyah.com">suhardiansyah.com </a>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title text-dark font-weight-bold" style="color:#212529 !important;" id="exampleModalCenterTitle">
                    Si Tepak Sirih - Masuk Sekarang</h2>
