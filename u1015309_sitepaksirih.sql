...
--
-- Host: localhost:3306
-- Generation Time: Nov 12, 2022 at 11:58 AM
-- Server version: 10.6.9-MariaDB-cll-lve
-- PHP Version: 7.4.30
...
--
-- Database: `u1015309_sitepaksirih`
--
...
INSERT INTO `bimbel` (`id_bimbel`, `nama_guru`, `nama_mapel`, `video`, `deskripsi`, `kelas`) VALUES
...
INSERT INTO `guru` (`id`, `nip`, `email`, `nama_guru`, `password`, `nama_mapel`) VALUES
(1, 0, 'suhar.guru@gmail.com', 'suhar', '$2y$10$3qQ2TYrtQHy44LblPMexnu4ZQrCWD.dYh20P.sOL5cyo6Z48fJQEq', 'modul1'),
(9, 19106, 'instruktur@gmail.com', 'instruktur apasaja', '$2y$10$bJUVa9qPZou27MN1BHcGwevvnpt1mdhKzj7Ga45/QgoQl8U7MNj9S', ''),
(10, 19132, 'ortopedi@gmail.com', 'instruktur ortopedi', '$2y$10$r6ifAq.5SI/CMsFhZGqa7O1IQ68R0eIPZvBvN2/jf.GJB2.6ElQw2', ''),
(11, 19151, 'kebidanan@gmail.com', 'instruktur kebidanan', '$2y$10$cQIWX72RNqS8pWOhkBzX8uRbzZPVMo0HvqSCumYVgywV8TFdCUtby', '');
...
INSERT INTO `mapel` (`id`, `n_mapel`, `id_guru`, `cover`) VALUES
(13, 'anastesi I', 0, ''),
(33, 'lasik mata', 3, 'modul1.png'),
(34, 'opgien', 5, 'modul21.png'),
(35, 'ortopedi', 7, 'modul31.png'),
(36, 'jantung', 6, 'modul38.png'),
(37, 'lasik mata', 9, 'modul11.png'),
(38, 'ortopedi dasar', 10, 'modul22.png'),
(39, 'kebidanan dasar', 11, 'modul39.png');
...
INSERT INTO `materi` (`id`, `nama_guru`, `nama_mapel`, `video`, `deskripsi`, `id_mapel`) VALUES
(95, 'instruktur apasaja', '', 'Yahoo_Mail_-_Penggantian_Hak_Akses_Sistem_OSS2.pdf', 'coba', 37),
(96, 'instruktur apasaja', '', 'WhatsApp_Video_2022-10-19_at_02_47_00.mp4', 'materi kedua', 37),
(97, 'instruktur ortopedi', '', 'CamScanner_11-09-2022_14_03_(1)3.pdf', 'materi 1', 38),
(98, 'instruktur ortopedi', '', 'WhatsApp_Video_2022-10-19_at_02_47_002.mp4', 'materi2', 38);
...
(39, 'suhar user', '$2y$10$djI2M/FQH2k3H7b6tLK5X.MZG1R.wrARoR6NerH3tsScNnsNCnexa', 'user@mail.com', '73349393_156861225523800_2119508204152772215_n_(1)6.jpg', 1, 1586163321),
(47, 'suhardiansyah', '$2y$10$djI2M/FQH2k3H7b6tLK5X.MZG1R.wrARoR6NerH3tsScNnsNCnexa', 'suhardiansyah16@gmail.com', 'default.jpg', 1, 0),
(48, 'suhar baru', '$2y$10$ZI2UmqUppAhHANLcMh2R4.4L3e11y1kJWl20HWVAZWFLe/aAanY/O', 'suhar.bisnis@gmail.com', 'default.jpg', 1, 0),
(49, 'siswa1', '$2y$10$DZmWsxS09xj8W0xpXVCks.qsYoPfI8oaKHgcNisTaseN1UoRzwt/i', 'siswa1@gmail.com', 'default.jpg', 1, 0);
...
--
-- Table structure for table `trmapel_guru`
--

CREATE TABLE `trmapel_guru` (
  `id` int(255) NOT NULL,
...
--
-- Dumping data for table `trmapel_guru`
--

INSERT INTO `trmapel_guru` (`id`, `id_mapel`, `id_guru`) VALUES
(1, 13, 1);
...
--
ALTER TABLE `bimbel`
  ADD PRIMARY KEY (`id_bimbel`) USING BTREE;
...
--
-- Indexes for table `trmapel_guru`
--
ALTER TABLE `trmapel_guru`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_mapel` (`id_mapel`),
  ADD KEY `fkey2` (`id_guru`);
...
--
ALTER TABLE `bimbel`
  MODIFY `id_bimbel` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
...
--
-- AUTO_INCREMENT for table `trmapel_guru`
--
ALTER TABLE `trmapel_guru`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- Constraints for table `trmapel_guru`
--
ALTER TABLE `trmapel_guru`
  ADD CONSTRAINT `fkey1` FOREIGN KEY (`id_mapel`) REFERENCES `mapel` (`id`),
  ADD CONSTRAINT `fkey2` FOREIGN KEY (`id_guru`) REFERENCES `guru` (`id`);
COMMIT;
